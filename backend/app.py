...
Indian Context Credit Card Fraud Detection System
"""
...
MERCHANTS = ['Flipkart', 'Amazon India', 'Swiggy', 'Zomato', 'BigBasket',
             ...
             'Hospital', 'Restaurant', 'Grocery Store', 'ATM Withdrawal', 'Utility Bill']
...
def predict():
    ...
    try:
        ...
        # ── Build feature DataFrame (keeps feature names for sklearn) ─────
        import pandas as pd
